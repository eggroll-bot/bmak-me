	...
	return (
		<div className="Home">
			...
			<Grid container align="center" justify="center" spacing={ 5 }>
				<Grid item>
					<Button color="primary" onClick={ ( ) => { history.push( "/about-me" ); } } size="medium" startIcon={ <InfoIcon /> } variant="outlined">About Me</Button>
				</Grid>

				<Grid item>
					<Button color="primary" onClick={ ( ) => { history.push( "/portfolio" ); } } size="medium" startIcon={ <CodeIcon /> } variant="outlined">Portfolio</Button>
				</Grid>
			</Grid>
		</div>
	);
